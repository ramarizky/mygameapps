...
public final class Networker: NetworkerProtocol {
    ...
    public func get<T>(type: T.Type, endPoint: NetworkFactory) -> AnyPublisher<T, Error> where T : Decodable {
    ...
    public func post<T>(type: T.Type, endPoint: NetworkFactory) -> AnyPublisher<T, Error> where T : Decodable {
